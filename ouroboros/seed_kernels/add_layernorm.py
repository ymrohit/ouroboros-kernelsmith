# GOLD seed kernel: fused residual-add + LayerNorm.  h = x + residual; y = LayerNorm(h)*w + b.
# Two reductions over h + affine, all fused. fp32. Eager: add, then a separate LN pass.
@triton.jit
