...
# ---------------- emit ------------------------------------------------------------------------
# the check count itself is a macro, so the paper's claim about its own build can't go stale
# (the hardcoded "12/12" it replaces had already drifted to 20 -- the exact failure mode)
put("consistencyChecks", len(CHECKS))
