...
evaluated under a separate baseline. The \stabOps{} \emph{all} clear a five-run stability
...
run (\S\ref{sec:invention}) evaluated against a different, default baseline and are not
folded into the reproducibility numbers. Every reproducibility claim in this paper concerns
the \stabOps{}.
...
kernels, plus \numKernelsExplore{} exploratory kernels under a separate baseline, repaired
