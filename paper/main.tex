...
against that referee, an open model produced \productKernels{} kernels that beat the
incumbent compiler reproducibly, repaired the one regime where it had been losing, and
contradicted our own predictions repeatedly along the way. The proposer ranged from 1B to
