...
\emph{mean} $-$ \emph{spread} $> 1$, i.e.\ $\overline{s} - \widehat{\sigma} > 1$, where
$\overline{s}$ is the mean speedup and $\widehat{\sigma}$ the population spread across the
five runs. Result: \textbf{\stabDiscoveries/\stabOps{} discoveries; zero failures;
