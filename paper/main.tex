...
practitioners still write by hand. The contribution is methodological: against a verifier
hardened and regression-tested against its known exploits, an open model out-searches the
...
run (\S\ref{sec:falsification}) evaluated against a different, default baseline and are not
